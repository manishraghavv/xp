...
- Name: services-dropdown.spec.ts >> Services dropdown (click-only) >> 4 · toggle, outside click, ESC focus return, and bar link while open
- Location: tests\e2e\services-dropdown.spec.ts:152:7
