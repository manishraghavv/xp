...
- Name: services-dropdown.spec.ts >> Services dropdown (click-only) >> 2 · each of the 9 items navigates to /services/[slug] and closes the panel
- Location: tests\e2e\services-dropdown.spec.ts:111:7
